 ...
 * accidental exits), the certificate page (it's printed), and /admin (its
 * own staff-only shell, not a student surface — these tabs are all student
 * destinations).
 */
...
export function MobileBottomNav() {
  ...
  // /career-readiness and /digital-marketing are the same: public landing
  // pages, but also where signed-in students land from a promo card.
  const onCommunity = pathname === '/community' || pathname.startsWith('/community/')
  const onPublicForSignedOut =
    onCommunity || pathname === '/career-readiness' || pathname === '/digital-marketing'
  const hidden =
