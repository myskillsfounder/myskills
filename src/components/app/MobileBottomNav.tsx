...
import { Dumbbell, Gamepad2, LayoutGrid, Star, User } from 'lucide-react'
...
const APP_PREFIXES = ['/dashboard', '/practice', '/games', '/community', '/feedback', '/profile']
...
export function MobileBottomNav() {
  ...
  return (
    <nav className="pointer-events-none fixed inset-x-0 bottom-0 z-30 flex justify-center px-4 pb-[max(0.85rem,env(safe-area-inset-bottom))] lg:hidden">
